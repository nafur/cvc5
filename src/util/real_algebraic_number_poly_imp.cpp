...
{
    *this = poly_utils::to_ran_with_refinement(poly::UPolynomial(poly_utils::to_integer(coefficients)), lower, upper);
}
RealAlgebraicNumber::RealAlgebraicNumber(
    ...
    const Rational& upper)
{
    ...
    *this = poly_utils::to_ran_with_refinement(poly::UPolynomial(std::move(coeffs)), lower, upper);
}
